...
input_TFile=ROOT.TFile.Open("./waveform_data_root/channel3_trig_n3p00.root", "READ")
RunSelector(input_TFile, "CH1,CH2,CH3", output_filename='channel3_trig_n3p00_cut_charge_n4400_level_n2p68')
