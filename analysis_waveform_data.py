...
def RunSelector(input_TFile, channels='CH1,CH2,CH3', output_filename='output_filename'):
    ...
    for _channel in list_channel:
        ...
        tree.Process("single_channel_selector.C+", "output_filename_{0}.root".format(_channel))
...
input_TFile=ROOT.TFile.Open("1000_square_waveform.root", "READ")

RunSelector(input_TFile, "CH1,CH2")
